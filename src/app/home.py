...
<p style="text-align:center;">Explorez nos clusters de recettes bio et traditionnelles et découvrez des patterns nutritionnels et sensoriels uniques.</p>
</div>
...
st.markdown("""
**Mangetamain**, leader de la recommandation B2C de recettes, met à votre disposition une application interactive qui vous permet de :  
...
Nous avons construit les clusters à partir d'une analyse regroupant plusieurs caractéristiques des recettes, telles que la composition nutritionnelle, les scores sensoriels, le nombre d’ingrédients et d’étapes, ainsi que les interactions et évaluations des utilisateurs.  

💡 Cliquez sur la page **“Méthodologie”** pour comprendre comment nous avons segmenté les recettes et construit nos visualisations.
""")
